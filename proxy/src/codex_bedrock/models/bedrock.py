# Portions of this file are derived from aws-samples/bedrock-access-gateway
# (https://github.com/aws-samples/bedrock-access-gateway), licensed under
# the Apache License 2.0. See NOTICE for details.
            ...
            for item in embeddings_request.input:
                if isinstance(item, str):
                    ...
                    raise HTTPException(
                        status_code=400,
                        detail=(
                            f"Unsupported input item type: {type(item).__name__}. Expected str, int, or list of ints."
                        ),
                    )
        else:
